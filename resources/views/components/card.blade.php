    ...
    <div class="card my-4" style="max-width: 400px;">
        <div class="content">
            ...
            <div class="front position-relative"
                ...
                <div class="bg-image hover-overlay ripple mt-4 p-4" data-mdb-ripple-color="light">
                    <img src="{{ optional($article->images->first())->getUrl(300, 300) ?? 'https://picsum.photos/400/300' }}"
